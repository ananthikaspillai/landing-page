...
function BannerFifth() {
  ...
  <div className="w-96 h-96 relative">
    <div className="w-96 h-96 left-[64px] top-0 absolute">
      ...
      <div className="w-[445px] h-[340px] left-[500px] top-[80px] absolute bg-white rounded-lg shadow">
        ...
        <img className="w-[78px] h-[70px] right-[300px] top-[20px] absolute" src={piping} />
        <img className="w-20 h-12 right-[894px] mt-[0px] absolute" src={quote} />
        ...
        <div className="left-[32px] top-[109px] absolute justify-start items-start gap-4 inline-flex">
          ...
          <div className="flex-col justify-start items-start gap-6 inline-flex">
            ...
            <div className="flex-col justify-start items-start flex">
              ...
              <img className="w-[16px] h-[16px] left-[20px] top-[0px] absolute" src={smallquote} />
      ...
      <div className="  ">
          ...
          <div className="w-[400px] h-[130px] text-zinc-900 text-5xl mt-[100px] font-extrabold font-['Inter']   ">Real Stories from Real Customers</div>
        </div>
