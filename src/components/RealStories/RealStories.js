...
function BannerFifth() {
  ...
  <div className="w-96 h-96 relative">
    <div className="w-96 h-96 left-[64px] top-0 absolute">
      ...
      <div className="w-[445px] h-[340px] left-[470px] top-[104px] absolute bg-white rounded-lg shadow">
        ...
        <img className="w-20 h-12 right-[894px] top-[0px] absolute" src={quote} />
      </div>
      ...
      <div className="w-[350px] h-[468px] left-[100px] top-[248px] absolute bg-white rounded-lg shadow mb-0">
        <div className="left-[32px] top-[104px] absolute justify-start items-start gap-4 inline-flex">
          <div className="w-4 h-3.5 relative opacity-30" />
          <div className="flex-col justify-start items-start gap-6 inline-flex">
